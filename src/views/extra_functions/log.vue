<template>
    <div class="app-container">
        <cus-wraper>
            <cus-filter-wraper>
                <el-input v-model="listQuery.username" placeholder="访问人" style="width: 200px;" clearable />
                <el-input v-model="listQuery.url" placeholder="url" style="width: 200px;" clearable />
                <el-date-picker
            ...
            <div class="table-container">
                <el-table v-loading="listLoading" :data="list" size="mini" element-loading-text="Loading" fit border highlight-current-row>
                    ...
                    <el-table-column label="访问IP" prop="ip" align="center" />
                    <el-table-column label="访问人" prop="username" align="center" />
...
<script>
import { getLogPage, saveOrUpdateLog, deleteLog } from '@/api/log'
