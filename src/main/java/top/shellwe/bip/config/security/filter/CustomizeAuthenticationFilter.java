package top.shellwe.bip.config.security.filter;


import top.shellwe.bip.config.Constants;
import top.shellwe.bip.config.security.dto.SecurityUser;
import top.shellwe.bip.config.security.log.MultiReadHttpServletResponse;
import top.shellwe.bip.config.security.login.AdminAuthenticationEntryPoint;
import top.shellwe.bip.config.security.service.impl.UserDetailsServiceImpl;
import top.shellwe.bip.util.MultiReadHttpServletRequest;
...
import top.shellwe.bip.util.MultiReadHttpServletResponse;
...
public class CustomizeAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected CustomizeAuthenticationFilter(UserDetailsServiceImpl userDetailsService) {
