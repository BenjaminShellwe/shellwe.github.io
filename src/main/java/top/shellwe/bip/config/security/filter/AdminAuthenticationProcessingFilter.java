...
import top.shellwe.bip.config.security.login.AdminAuthenticationFailureHandler;
import top.shellwe.bip.config.security.login.AdminAuthenticationSuccessHandler;
import top.shellwe.bip.config.security.login.CusAuthenticationManager;
...
public class AdminAuthenticationProcessingFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        try {
            ...
            authRequest = new UsernamePasswordAuthenticationToken(user.getUserName(), user.getUserPassword(), null);
